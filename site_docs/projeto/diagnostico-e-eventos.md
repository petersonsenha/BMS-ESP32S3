...
- [Interface do log de eventos](../assets/codigo-fonte/bms_event_log.h)
- [Implementacao do log de eventos](../assets/codigo-fonte/bms_event_log.cpp)
- [Servico de comandos em runtime](../assets/codigo-fonte/bms_runtime_config_service.cpp)
- [Bootstrap e loop principal](../assets/codigo-fonte/main.cpp)
